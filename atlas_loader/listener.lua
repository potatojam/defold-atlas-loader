...
---@return listener
function M.create()
    ---@type table<function|url, {message_id: hash, trigger: function}[]>
    local listeners = {}
    ...
    ---@param url_or_fn_to_add url|function|nil URL or function to call. Can be nil in which case the current URL is used.
    ---@param message_id hash|string|nil Optional message id to filter on
    ...
    ---@param url_or_fn_to_remove url|function|nil
    ---@param message_id hash|string|nil Optional message_id to limit removal to
    ...
    ---@param message_id hash|string Id of message to trigger
    ---@param message table|nil The message itself (can be nil)
